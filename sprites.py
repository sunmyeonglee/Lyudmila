...
class Pow(pg.sprite.Sprite):
    def __init__(self, game, plat):
        ...
        if game.score > 400:
            images = [
                self.game.spritesheet.get_image(826, 1220, 71, 70),
                self.game.spritesheet.get_image(826, 1292, 71, 70),
            ]
        else:
...
class Mob(pg.sprite.Sprite):
    def __init__(self, game):
        ...
        self.game = game
        if game.score > 400:
            self.image_up = self.game.spritesheet.get_image(0, 1456, 220, 207)
            self.image_down = self.game.spritesheet.get_image(0, 1456, 220, 207)
        else:
            # self.image_up = self.game.spritesheet.get_image(566, 510, 122, 139)
            # self.image_down = self.game.spritesheet.get_image(568, 1534, 122, 135)
            self.image_up = self.game.spritesheet.get_image(0, 1662, 220, 215)
            self.image_down = self.game.spritesheet.get_image(0, 1662, 220, 215)
